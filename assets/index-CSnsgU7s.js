(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))o(i);new MutationObserver(i=>{for(const s of i)if(s.type==="childList")for(const l of s.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&o(l)}).observe(document,{childList:!0,subtree:!0});function a(i){const s={};return i.integrity&&(s.integrity=i.integrity),i.referrerPolicy&&(s.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?s.credentials="include":i.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function o(i){if(i.ep)return;i.ep=!0;const s=a(i);fetch(i.href,s)}})();const c={slides:[{id:"slide-1",content:`
      ...
      ${i}
    `,this.shadow.appendChild(o);const s=document.createElement("div");s.className="slide-frame",s.innerHTML=a.content,s.contentEditable=!0,s.style.outline="none",this.shadow.appendChild(s),s.querySelectorAll("img").forEach(r=>{(r.dataset.cropZoom||r.dataset.cropX||r.dataset.cropY)&&H(r);const m=r.parentElement;m&&(m.dataset.frameW||(r.style.setProperty("width","100%","important"),r.style.setProperty("height","100%","important"),m.style.overflow="hidden"))}),s.addEventListener("input",()=>{c.slides[t].content=s.innerHTML,Z(t)}),s.addEventListener("click",r=>{r.target.tagName==="IMG"?(M(),K(r.target)):r.target!==s?(k(),V(r.target)):(k(),M())});const l=this.shadow;s.addEventListener("mouseup",()=>{setTimeout(()=>{const r=typeof l.getSelection=="function"?l.getSelection():document.getSelection();r&&!r.isCollapsed&&r.toString().trim()?e.textFormatPanel.classList.remove("hidden"):e.textFormatPanel.classList.add("hidden")},10)})}}const G=new _(e.currentSlideHost);function N(){const n=e.slideList.clientWidth;if(n<=0)return;const a=(n-32)/1122.5;document.querySelectorAll(".thumb-preview").forEach(o=>{o.style.setProperty("--thumb-scale",a)})}const J=new ResizeObserver(()=>{N()});J.observe(e.slideList);const W="drop-shadow(0 0 3px #6366f1) drop-shadow(0 0 1px #6366f1)";function K(n){d&&(d.classList.remove("active-editing"),d.parentElement&&(d.parentElement.style.filter="")),d=n,d.classList.add("active-editing"),e.cropZoom.value=n.dataset.cropZoom||100,e.cropX.value=n.dataset.cropX||0,e.cropY.value=n.dataset.cropY||0,H(n);const t=n.parentElement;if(t){if(!t.dataset.origH){const m=t.style.height,g=t.style.width;t.style.height="",t.style.width="",t.style.maxWidth="",t.style.marginLeft="",t.style.marginRight="",t.dataset.origH=t.offsetHeight,t.dataset.origW=t.offsetWidth,t.style.height=m,t.style.width=g}const a=parseFloat(t.dataset.frameW)||100,o=parseFloat(t.dataset.frameH)||100;e.inputImgWidth.value=a,e.valImgWidth.value=a,e.inputImgHeight.value=o,e.valImgHeight.value=o;let i=0,s=0;const r=window.getComputedStyle(t).transform;if(r&&r!=="none"){const m=r.match(/matrix\(([^)]+)\)/);if(m){const g=m[1].split(",").map(Number);i=Math.round(g[4])||0,s=Math.round(g[5])||0}}e.inputImgPosY.value=s,e.valImgPosY.value=s,e.inputImgPosX.value=i,e.valImgPosX.value=i,v()}e.imagePanel.classList.remove("hidden")}function k(){d&&(d.classList.remove("active-editing"),d.style.removeProperty("filter"),d.parentElement&&(d.parentElement.style.filter="")),d=null,e.imagePanel.classList.add("hidden")}function V(n){u&&u.classList.remove("active-text-editing"),u=n,u.classList.add("active-text-editing");const t=window.getComputedStyle(n),a=Math.round(parseFloat(t.fontSize));e.inputTextFontSize.value=a,e.valFontSize.value=a;const o=parseFloat(t.lineHeight)/parseFloat(t.fontSize)||1.5;e.inputTextLineHeight.value=o.toFixed(1),e.valLineHeight.value=o.toFixed(1);let i=0,s=0;const l=t.transform;if(l&&l!=="none"){const r=l.match(/matrix\(([^)]+)\)/);if(r){const m=r[1].split(",").map(Number);i=Math.round(m[4])||0,s=Math.round(m[5])||0}}e.inputTextPosY.value=s,e.valTextPosY.value=s,e.inputTextPosX.value=i,e.valTextPosX.value=i,e.textPanel.classList.remove("hidden")}function M(){u&&u.classList.remove("active-text-editing"),u=null,e.textPanel.classList.add("hidden"),e.textFormatPanel.classList.add("hidden")}function Q(){d&&(d.dataset.cropZoom=e.cropZoom.value,d.dataset.cropX=e.cropX.value,d.dataset.cropY=e.cropY.value,H(d),v())}function H(n){const t=Math.max(1,(n.dataset.cropZoom||100)/100),a=parseFloat(n.dataset.cropX||0),o=parseFloat(n.dataset.cropY||0),i=50+a/2,s=50+o/2;n.style.setProperty("object-fit","cover","important"),n.style.setProperty("object-position",`${i}% ${s}%`,"important"),n.style.setProperty("transform-origin",`${i}% ${s}%`,"important"),n.style.setProperty("transform",`scale(${t})`,"important")}function v(){if(!d||!d.parentElement)return;const n=d.parentElement,t=parseFloat(e.inputImgWidth.value),a=parseFloat(e.inputImgHeight.value),o=parseFloat(n.dataset.origH)||n.offsetHeight;n.dataset.frameW=t,n.dataset.frameH=a;const i=t>100||a>100;n.style.filter="",d.style.removeProperty("filter"),n.style.width="",n.style.maxWidth="",n.style.height="",n.style.marginLeft="",n.style.marginRight="",n.style.marginBottom="";const s=Math.max(t,100),l=Math.max(a,100);d.style.setProperty("width",s+"%","important"),d.style.setProperty("height",l+"%","important");const r=t<100?(100-t)/2:0,m=a<100?(100-a)/2:0,g=Math.max(1,(d.dataset.cropZoom||100)/100),B=parseFloat(d.dataset.cropX||0),E=parseFloat(d.dataset.cropY||0),w=50+B/2,y=50+E/2,f=(g-1)/g;if(i){n.style.overflow="visible",n.style.clipPath="",d.style.setProperty("position","relative","important"),d.style.setProperty("left",t>100?`${-(s-100)/2}%`:"0","important"),d.style.setProperty("top","0","important");const $=m+y*f,F=r+(100-w)*f,z=m+(100-y)*f,X=r+w*f;$||F||z||X?d.style.setProperty("clip-path",`inset(${$}% ${F}% ${z}% ${X}%)`,"important"):d.style.removeProperty("clip-path"),a>100&&(n.style.marginBottom=o*(a-100)/100+"px")}else n.style.overflow="hidden",n.style.clipPath=r||m?`inset(${m}% ${r}%)`:"",d.style.removeProperty("position"),d.style.removeProperty("left"),d.style.removeProperty("top"),d.style.removeProperty("clip-path");const T=parseFloat(e.inputImgPosX.value)||0,P=parseFloat(e.inputImgPosY.value)||0;n.style.transform=T||P?`translate(${T}px, ${P}px)`:"",h(),i?d.style.setProperty("filter",W,"important"):n.style.filter=W}function h(){const n=e.currentSlideHost.shadowRoot;if(!n)return;const t=n.querySelector(".slide-frame");t&&(c.slides[c.currentIndex].content=t.innerHTML,Z(c.currentIndex))}function ee(){A(),x(0),te(),q(),window.addEventListener("resize",q)}function x(n){c.currentIndex=n,G.render(n),document.querySelectorAll(".thumb-item").forEach((t,a)=>{t.classList.toggle("active",a===n)}),document.getElementById("current-index").textContent=n+1}function D(n){const t=document.createElement("div");return t.className="drop-zone",t.dataset.gapIndex=n,t.addEventListener("dragover",a=>{a.preventDefault(),a.dataTransfer.dropEffect="move",C(n)}),t.addEventListener("dragleave",()=>{t.classList.remove("active")}),t.addEventListener("drop",a=>{a.preventDefault(),O(n)}),t}function A(){e.slideList.innerHTML="",c.slides.forEach((n,t)=>{e.slideList.appendChild(D(t));const a=document.createElement("div");a.className="thumb-item",a.draggable=!0,a.onclick=()=>x(t),a.addEventListener("dragstart",l=>{p=t,a.classList.add("dragging"),l.dataTransfer.effectAllowed="move"}),a.addEventListener("dragover",l=>{if(l.preventDefault(),l.dataTransfer.dropEffect="move",p===null||p===t)return;const r=a.getBoundingClientRect(),m=(l.clientY-r.top)/r.height;m<.25?C(t):m>.75?C(t+1):b()}),a.addEventListener("dragleave",()=>{}),a.addEventListener("drop",l=>{l.preventDefault(),S!==null?O(S):b()}),a.addEventListener("dragend",()=>{a.classList.remove("dragging"),b(),L(),p=null});const o=document.createElement("div");o.className="thumb-preview";const i=o.attachShadow({mode:"open"});let s=c.globalStyles+(n.css||"");s=s.replace(/100vw/g,"100%").replace(/100vh/g,"100%"),s=s.replace(/:root/g,":host"),s=s.replace(/(^|,)\s*body(?=\s|\{|,)/gi,"$1 .slide-frame"),s=s.replace(/html(?=\s|\{|,)/gi,":host"),i.innerHTML=`
      <style>
        :host { 
          display: block; 
          width: 100%; 
