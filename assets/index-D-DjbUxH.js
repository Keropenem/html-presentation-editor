(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))n(i);new MutationObserver(i=>{for(const s of i)if(s.type==="childList")for(const l of s.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&n(l)}).observe(document,{childList:!0,subtree:!0});function a(i){const s={};return i.integrity&&(s.integrity=i.integrity),i.referrerPolicy&&(s.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?s.credentials="include":i.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function n(i){if(i.ep)return;i.ep=!0;const s=a(i);fetch(i.href,s)}})();const d={slides:[{id:"slide-1",content:`
      ...
      ${i}
    `,this.shadow.appendChild(n);const s=document.createElement("div");s.className="slide-frame",s.innerHTML=a.content,s.contentEditable=!0,s.style.outline="none",this.shadow.appendChild(s),s.querySelectorAll("img").forEach(r=>{(r.dataset.cropZoom||r.dataset.cropX||r.dataset.cropY)&&B(r);const m=r.parentElement;m&&(m.dataset.frameW||(r.style.setProperty("width","100%","important"),r.style.setProperty("height","100%","important"),m.style.overflow="hidden"))}),s.addEventListener("input",()=>{d.slides[o].content=s.innerHTML,W(o)}),s.addEventListener("click",r=>{r.target.tagName==="IMG"?(T(),j(r.target)):r.target!==s?(C(),U(r.target)):(C(),T())});const l=this.shadow;s.addEventListener("mouseup",()=>{setTimeout(()=>{const r=typeof l.getSelection=="function"?l.getSelection():document.getSelection();r&&!r.isCollapsed&&r.toString().trim()?e.textFormatPanel.classList.remove("hidden"):e.textFormatPanel.classList.add("hidden")},10)})}}const O=new q(e.currentSlideHost);function z(){const t=e.slideList.clientWidth;if(t<=0)return;const a=(t-32)/1122.5;document.querySelectorAll(".thumb-preview").forEach(n=>{n.style.setProperty("--thumb-scale",a)})}const N=new ResizeObserver(()=>{z()});N.observe(e.slideList);const Z="drop-shadow(0 0 3px #6366f1) drop-shadow(0 0 1px #6366f1)";function j(t){c&&(c.classList.remove("active-editing"),c.parentElement&&(c.parentElement.style.filter="")),c=t,c.classList.add("active-editing"),e.cropZoom.value=t.dataset.cropZoom||100,e.cropX.value=t.dataset.cropX||0,e.cropY.value=t.dataset.cropY||0,B(t);const o=t.parentElement;if(o){o.dataset.origH||(o.dataset.origH=o.offsetHeight,o.dataset.origW=o.offsetWidth);const a=parseFloat(o.dataset.frameW)||100,n=parseFloat(o.dataset.frameH)||100;e.inputImgWidth.value=a,e.valImgWidth.value=a,e.inputImgHeight.value=n,e.valImgHeight.value=n;let i=0,s=0;const r=window.getComputedStyle(o).transform;if(r&&r!=="none"){const m=r.match(/matrix\(([^)]+)\)/);if(m){const g=m[1].split(",").map(Number);i=Math.round(g[4])||0,s=Math.round(g[5])||0}}e.inputImgPosY.value=s,e.valImgPosY.value=s,e.inputImgPosX.value=i,e.valImgPosX.value=i,b()}e.imagePanel.classList.remove("hidden")}function C(){c&&(c.classList.remove("active-editing"),c.parentElement&&(c.parentElement.style.filter="")),c=null,e.imagePanel.classList.add("hidden")}function U(t){u&&u.classList.remove("active-text-editing"),u=t,u.classList.add("active-text-editing");const o=window.getComputedStyle(t),a=Math.round(parseFloat(o.fontSize));e.inputTextFontSize.value=a,e.valFontSize.value=a;const n=parseFloat(o.lineHeight)/parseFloat(o.fontSize)||1.5;e.inputTextLineHeight.value=n.toFixed(1),e.valLineHeight.value=n.toFixed(1);let i=0,s=0;const l=o.transform;if(l&&l!=="none"){const r=l.match(/matrix\(([^)]+)\)/);if(r){const m=r[1].split(",").map(Number);i=Math.round(m[4])||0,s=Math.round(m[5])||0}}e.inputTextPosY.value=s,e.valTextPosY.value=s,e.inputTextPosX.value=i,e.valTextPosX.value=i,e.textPanel.classList.remove("hidden")}function T(){u&&u.classList.remove("active-text-editing"),u=null,e.textPanel.classList.add("hidden"),e.textFormatPanel.classList.add("hidden")}function _(){c&&(c.dataset.cropZoom=e.cropZoom.value,c.dataset.cropX=e.cropX.value,c.dataset.cropY=e.cropY.value,B(c),f())}function B(t){const o=Math.max(1,(t.dataset.cropZoom||100)/100),a=parseFloat(t.dataset.cropX||0),n=parseFloat(t.dataset.cropY||0),i=50+a/2,s=50+n/2;t.style.setProperty("object-fit","cover","important"),t.style.setProperty("object-position",`${i}% ${s}%`,"important"),t.style.setProperty("transform-origin",`${i}% ${s}%`,"important"),t.style.setProperty("transform",`scale(${o})`,"important")}function b(){if(!c||!c.parentElement)return;const t=c.parentElement,o=parseFloat(e.inputImgWidth.value),a=parseFloat(e.inputImgHeight.value),n=parseFloat(t.dataset.origH)||t.offsetHeight,i=parseFloat(t.dataset.origW)||t.offsetWidth;if(t.dataset.frameW=o,t.dataset.frameH=a,t.style.filter="",c.style.setProperty("width","100%","important"),c.style.setProperty("height","100%","important"),c.style.removeProperty("position"),c.style.removeProperty("left"),c.style.removeProperty("top"),c.style.removeProperty("clip-path"),c.style.removeProperty("filter"),t.style.overflow="hidden",o>100&&i){const g=i*o/100,I=g-i;t.style.width=g+"px",t.style.maxWidth="none",t.style.marginLeft=-I/2+"px",t.style.marginRight=-I/2+"px"}else t.style.width="",t.style.maxWidth="",t.style.marginLeft="",t.style.marginRight="";a>100&&n?(t.style.height=n*a/100+"px",o<=100&&(t.style.width=i+"px",t.style.maxWidth="none")):t.style.height="";const s=o<100?(100-o)/2:0,l=a<100?(100-a)/2:0;t.style.clipPath=s||l?`inset(${l}% ${s}%)`:"";const r=parseFloat(e.inputImgPosX.value)||0,m=parseFloat(e.inputImgPosY.value)||0;t.style.transform=r||m?`translate(${r}px, ${m}px)`:"",f(),t.style.filter=Z}function f(){const t=e.currentSlideHost.shadowRoot;if(!t)return;const o=t.querySelector(".slide-frame");o&&(d.slides[d.currentIndex].content=o.innerHTML,W(d.currentIndex))}function G(){k(),y(0),J(),F(),window.addEventListener("resize",F)}function y(t){d.currentIndex=t,O.render(t),document.querySelectorAll(".thumb-item").forEach((o,a)=>{o.classList.toggle("active",a===t)}),document.getElementById("current-index").textContent=t+1}function H(t){const o=document.createElement("div");return o.className="drop-zone",o.dataset.gapIndex=t,o.addEventListener("dragover",a=>{a.preventDefault(),a.dataTransfer.dropEffect="move",S(t)}),o.addEventListener("dragleave",()=>{o.classList.remove("active")}),o.addEventListener("drop",a=>{a.preventDefault(),$(t)}),o}function k(){e.slideList.innerHTML="",d.slides.forEach((t,o)=>{e.slideList.appendChild(H(o));const a=document.createElement("div");a.className="thumb-item",a.draggable=!0,a.onclick=()=>y(o),a.addEventListener("dragstart",l=>{p=o,a.classList.add("dragging"),l.dataTransfer.effectAllowed="move"}),a.addEventListener("dragover",l=>{if(l.preventDefault(),l.dataTransfer.dropEffect="move",p===null||p===o)return;const r=a.getBoundingClientRect(),m=(l.clientY-r.top)/r.height;m<.25?S(o):m>.75?S(o+1):v()}),a.addEventListener("dragleave",()=>{}),a.addEventListener("drop",l=>{l.preventDefault(),w!==null?$(w):v()}),a.addEventListener("dragend",()=>{a.classList.remove("dragging"),v(),E(),p=null});const n=document.createElement("div");n.className="thumb-preview";const i=n.attachShadow({mode:"open"});let s=d.globalStyles+(t.css||"");s=s.replace(/100vw/g,"100%").replace(/100vh/g,"100%"),s=s.replace(/:root/g,":host"),s=s.replace(/(^|,)\s*body(?=\s|\{|,)/gi,"$1 .slide-frame"),s=s.replace(/html(?=\s|\{|,)/gi,":host"),i.innerHTML=`
      <style>
        :host { 
          display: block; 
          width: 100%; 
