(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))o(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const l of a.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&o(l)}).observe(document,{childList:!0,subtree:!0});function i(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function o(s){if(s.ep)return;s.ep=!0;const a=i(s);fetch(s.href,a)}})();const c={slides:[{id:"slide-1",content:`
      ...
      ${s}
    `,this.shadow.appendChild(o);const a=document.createElement("div");a.className="slide-frame",a.innerHTML=i.content,a.contentEditable=!0,a.style.outline="none",this.shadow.appendChild(a),a.querySelectorAll("img").forEach(r=>{(r.dataset.cropZoom||r.dataset.cropX||r.dataset.cropY)&&$(r);const m=r.parentElement;m&&(m.dataset.frameW||(r.style.setProperty("width","100%","important"),r.style.setProperty("height","100%","important"),m.style.overflow="hidden"))}),a.addEventListener("input",()=>{c.slides[t].content=a.innerHTML,N(t)}),a.addEventListener("click",r=>{r.target.tagName==="IMG"?(A(),J(r.target)):r.target!==a?(H(),K(r.target)):(H(),A())});const l=this.shadow;a.addEventListener("mouseup",()=>{setTimeout(()=>{const r=typeof l.getSelection=="function"?l.getSelection():document.getSelection();r&&!r.isCollapsed&&r.toString().trim()?e.textFormatPanel.classList.remove("hidden"):e.textFormatPanel.classList.add("hidden")},10)})}}const U=new Z(e.currentSlideHost);function q(){const n=e.slideList.clientWidth;if(n<=0)return;const i=(n-32)/1122.5;document.querySelectorAll(".thumb-preview").forEach(o=>{o.style.setProperty("--thumb-scale",i)})}const _=new ResizeObserver(()=>{q()});_.observe(e.slideList);const G="drop-shadow(0 0 3px #6366f1) drop-shadow(0 0 1px #6366f1)";function J(n){d&&(d.classList.remove("active-editing"),d.parentElement&&(d.parentElement.style.filter="")),d=n,d.classList.add("active-editing"),e.cropZoom.value=n.dataset.cropZoom||100,e.cropX.value=n.dataset.cropX||0,e.cropY.value=n.dataset.cropY||0,$(n);const t=n.parentElement;if(t){if(!t.dataset.origH){const m=t.style.height,p=t.style.width;t.style.height="",t.style.width="",t.style.maxWidth="",t.style.marginLeft="",t.style.marginRight="",t.dataset.origH=t.offsetHeight,t.dataset.origW=t.offsetWidth,t.style.height=m,t.style.width=p}const i=parseFloat(t.dataset.frameW)||100,o=parseFloat(t.dataset.frameH)||100;e.inputImgWidth.value=i,e.valImgWidth.value=i,e.inputImgHeight.value=o,e.valImgHeight.value=o;let s=0,a=0;const r=window.getComputedStyle(t).transform;if(r&&r!=="none"){const m=r.match(/matrix\(([^)]+)\)/);if(m){const p=m[1].split(",").map(Number);s=Math.round(p[4])||0,a=Math.round(p[5])||0}}e.inputImgPosY.value=a,e.valImgPosY.value=a,e.inputImgPosX.value=s,e.valImgPosX.value=s,S()}e.imagePanel.classList.remove("hidden")}function H(){d&&(d.classList.remove("active-editing"),d.style.removeProperty("filter"),d.parentElement&&(d.parentElement.style.filter="")),d=null,e.imagePanel.classList.add("hidden")}function K(n){g&&g.classList.remove("active-text-editing"),g=n,g.classList.add("active-text-editing");const t=window.getComputedStyle(n),i=Math.round(parseFloat(t.fontSize));e.inputTextFontSize.value=i,e.valFontSize.value=i;const o=parseFloat(t.lineHeight)/parseFloat(t.fontSize)||1.5;e.inputTextLineHeight.value=o.toFixed(1),e.valLineHeight.value=o.toFixed(1);let s=0,a=0;const l=t.transform;if(l&&l!=="none"){const r=l.match(/matrix\(([^)]+)\)/);if(r){const m=r[1].split(",").map(Number);s=Math.round(m[4])||0,a=Math.round(m[5])||0}}e.inputTextPosY.value=a,e.valTextPosY.value=a,e.inputTextPosX.value=s,e.valTextPosX.value=s,e.textPanel.classList.remove("hidden")}function A(){g&&g.classList.remove("active-text-editing"),g=null,e.textPanel.classList.add("hidden"),e.textFormatPanel.classList.add("hidden")}function V(){d&&(d.dataset.cropZoom=e.cropZoom.value,d.dataset.cropX=e.cropX.value,d.dataset.cropY=e.cropY.value,$(d),h())}function $(n){const t=Math.max(1,(n.dataset.cropZoom||100)/100),i=parseFloat(n.dataset.cropX||0),o=parseFloat(n.dataset.cropY||0),s=50+i/2,a=50+o/2;if(n.style.setProperty("object-fit","cover","important"),n.style.setProperty("object-position",`${s}% ${a}%`,"important"),t>1){const l=50/t,r=50/t,m=Math.max(l,Math.min(100-l,s)),p=Math.max(r,Math.min(100-r,a)),v=p-r,b=100-m-l,I=100-p-r,f=m-l;n.style.setProperty("object-view-box",`inset(${v}% ${b}% ${I}% ${f}%)`,"important")}else n.style.removeProperty("object-view-box")}function S(){if(!d||!d.parentElement)return;const n=d.parentElement;let t=parseFloat(e.inputImgWidth.value),i=parseFloat(e.inputImgHeight.value);const o=parseFloat(n.dataset.origH)||n.offsetHeight,s=d.naturalWidth,a=d.naturalHeight,l=parseFloat(n.dataset.origW)||n.offsetWidth,r=o;if(s&&a&&l&&r){const x=s/a,P=l/r,E=Math.max(100,Math.round(x/P*100)),z=Math.max(100,Math.round(P/x*100));t>E&&(t=E,e.inputImgWidth.value=t,e.valImgWidth.value=t),i>z&&(i=z,e.inputImgHeight.value=i,e.valImgHeight.value=i)}n.dataset.frameW=t,n.dataset.frameH=i;const m=t>100||i>100;n.style.filter="",d.style.removeProperty("filter"),n.style.width="",n.style.maxWidth="",n.style.height="",n.style.marginLeft="",n.style.marginRight="",n.style.marginBottom="",n.style.overflow="",n.style.visibility="",n.style.position="",n.style.zIndex="";const p=t<100?(100-t)/2:0,v=i<100?(100-i)/2:0;if(m){const x=Math.max(t,100)/100,P=Math.max(i,100)/100;d.style.setProperty("width",Math.max(t,100)+"%","important"),d.style.setProperty("height",Math.max(i,100)+"%","important");const E=[];x!==1&&E.push(`scaleX(${1/x})`),P!==1&&E.push(`scaleY(${1/P})`),E.length?(d.style.setProperty("transform",E.join(" "),"important"),d.style.setProperty("transform-origin","left top","important")):(d.style.removeProperty("transform"),d.style.removeProperty("transform-origin")),p||v?n.style.clipPath=`inset(${v}% ${p}%)`:n.style.clipPath="",i>100&&(n.style.marginBottom=o*(i-100)/100+"px")}else d.style.setProperty("width","100%","important"),d.style.setProperty("height","100%","important"),d.style.removeProperty("transform"),d.style.removeProperty("transform-origin"),n.style.overflow="hidden",n.style.clipPath=p||v?`inset(${v}% ${p}%)`:"";const b=parseFloat(e.inputImgPosX.value)||0,I=parseFloat(e.inputImgPosY.value)||0,f=m?Math.max(t,100)/100:1,y=m?Math.max(i,100)/100:1,T=[];(b||I)&&T.push(`translate(${b}px, ${I}px)`),(f!==1||y!==1)&&T.push(`scale(${f}, ${y})`),n.style.transform=T.join(" ")||"",n.style.transformOrigin=m?"center top":"",h(),n.style.filter=G}function h(){const n=e.currentSlideHost.shadowRoot;if(!n)return;const t=n.querySelector(".slide-frame");t&&(c.slides[c.currentIndex].content=t.innerHTML,N(c.currentIndex))}function Q(){F(),L(0),ee(),R(),window.addEventListener("resize",R)}function L(n){c.currentIndex=n,U.render(n),document.querySelectorAll(".thumb-item").forEach((t,i)=>{t.classList.toggle("active",i===n)}),document.getElementById("current-index").textContent=n+1}function X(n){const t=document.createElement("div");return t.className="drop-zone",t.dataset.gapIndex=n,t.addEventListener("dragover",i=>{i.preventDefault(),i.dataTransfer.dropEffect="move",k(n)}),t.addEventListener("dragleave",()=>{t.classList.remove("active")}),t.addEventListener("drop",i=>{i.preventDefault(),D(n)}),t}function F(){e.slideList.innerHTML="",c.slides.forEach((n,t)=>{e.slideList.appendChild(X(t));const i=document.createElement("div");i.className="thumb-item",i.draggable=!0,i.onclick=()=>L(t),i.addEventListener("dragstart",l=>{u=t,i.classList.add("dragging"),l.dataTransfer.effectAllowed="move"}),i.addEventListener("dragover",l=>{if(l.preventDefault(),l.dataTransfer.dropEffect="move",u===null||u===t)return;const r=i.getBoundingClientRect(),m=(l.clientY-r.top)/r.height;m<.25?k(t):m>.75?k(t+1):w()}),i.addEventListener("dragleave",()=>{}),i.addEventListener("drop",l=>{l.preventDefault(),M!==null?D(M):w()}),i.addEventListener("dragend",()=>{i.classList.remove("dragging"),w(),C(),u=null});const o=document.createElement("div");o.className="thumb-preview";const s=o.attachShadow({mode:"open"});let a=c.globalStyles+(n.css||"");a=a.replace(/100vw/g,"100%").replace(/100vh/g,"100%"),a=a.replace(/:root/g,":host"),a=a.replace(/(^|,)\s*body(?=\s|\{|,)/gi,"$1 .slide-frame"),a=a.replace(/html(?=\s|\{|,)/gi,":host"),s.innerHTML=`
      <style>
        :host { 
          display: block; 
          width: 100%; 
    ...
    `,i.appendChild(o),e.slideList.appendChild(i)}),e.slideList.appendChild(X(c.slides.length)),setTimeout(q,0),document.getElementById("total-slides").textContent=c.slides.length}function N(n){const t=Array.from(e.slideList.querySelectorAll(".thumb-item"));if(t[n]){const o=t[n].querySelector(".thumb-preview").shadowRoot.querySelector(".slide-frame");o&&(o.innerHTML=c.slides[n].content)}}function ee(){const n=e.slideList.closest(".sidebar");n.addEventListener("dragover",o=>{u!==null&&j(o.clientY,n)}),n.addEventListener("dragleave",o=>{n.contains(o.relatedTarget)||C()}),n.addEventListener("drop",()=>C()),e.btnPaste.addEventListener("click",()=>{e.pasteInput.value="",e.pasteModal.classList.remove("hidden")}),e.btnPasteConfirm.addEventListener("click",()=>{e.pasteInput.value.trim()&&(Y(e.pasteInput.value),e.pasteModal.classList.add("hidden"))}),e.btnPasteCancel.addEventListener("click",()=>e.pasteModal.classList.add("hidden")),e.btnClosePasteModal.addEventListener("click",()=>e.pasteModal.classList.add("hidden")),e.btnImport.addEventListener("click",()=>e.fileInputHtml.click()),e.fileInputHtml.addEventListener("change",o=>{const s=o.target.files[0];if(s){const a=new FileReader;a.onload=l=>Y(l.target.result),a.readAsText(s)}}),[e.cropZoom,e.cropX,e.cropY].forEach(o=>{o.addEventListener("input",V)}),e.btnCloseImagePanel.addEventListener("click",H),e.btnChangeImageAlt.addEventListener("click",()=>e.fileInputImage.click()),e.fileInputImage.addEventListener("change",o=>{const s=o.target.files[0];if(s&&d){const a=new FileReader;a.onload=l=>{d.src=l.target.result,h(),o.target.value=""},a.readAsDataURL(s)}}),e.btnTextBold.addEventListener("mousedown",o=>{o.preventDefault(),document.execCommand("bold"),h()}),e.btnTextItalic.addEventListener("mousedown",o=>{o.preventDefault(),document.execCommand("italic"),h()}),e.btnTextUnderline.addEventListener("mousedown",o=>{o.preventDefault(),document.execCommand("underline"),h()}),e.colorSwatches.forEach(o=>{o.addEventListener("mousedown",s=>{s.preventDefault();const a=o.dataset.color;document.execCommand("styleWithCSS",!1,!0),document.execCommand("foreColor",!1,a),h()})});function t(o,s,a){o.addEventListener("input",l=>{s.value=l.target.value,a(l.target.value)}),s.addEventListener("input",l=>{o.value=l.target.value,a(l.target.value)})}t(e.inputTextFontSize,e.valFontSize,o=>{g&&(g.style.fontSize=o+"px",h())}),t(e.inputTextLineHeight,e.valLineHeight,o=>{g&&(g.style.lineHeight=o,h())});function i(){if(!g)return;const o=e.inputTextPosY.value||0,s=e.inputTextPosX.value||0;g.style.transform=`translate(${s}px, ${o}px)`,h()}t(e.inputTextPosY,e.valTextPosY,()=>i()),t(e.inputTextPosX,e.valTextPosX,()=>i()),e.btnCloseTextPanel.addEventListener("click",A),t(e.inputImgWidth,e.valImgWidth,()=>S()),t(e.inputImgHeight,e.valImgHeight,()=>S()),t(e.inputImgPosY,e.valImgPosY,()=>S()),t(e.inputImgPosX,e.valImgPosX,()=>S()),document.querySelectorAll(".btn-reset").forEach(o=>{o.addEventListener("click",s=>{s.preventDefault();const a=o.dataset.slider,l=o.dataset.val,r=o.dataset.default,m=document.getElementById(a);if(m&&(m.value=r,m.dispatchEvent(new Event("input",{bubbles:!0}))),l){const p=document.getElementById(l);p&&(p.value=r)}})}),e.btnExportHtml.addEventListener("click",()=>e.exportModal.classList.remove("hidden")),e.btnExportConfirm.addEventListener("click",()=>{ne(e.checkPresentationMode.checked),e.exportModal.classList.add("hidden")}),e.btnExportCancel.addEventListener("click",()=>e.exportModal.classList.add("hidden")),e.btnCloseExportModal.addEventListener("click",()=>e.exportModal.classList.add("hidden")),e.btnPrint.addEventListener("click",()=>e.printModal.classList.remove("hidden")),e.printLayoutCards.forEach(o=>{o.addEventListener("click",()=>{e.printLayoutCards.forEach(s=>s.classList.remove("active")),o.classList.add("active")})}),e.btnPrintConfirm.addEventListener("click",()=>{const o=document.querySelector('input[name="print-layout"]:checked');e.printModal.classList.add("hidden"),te(parseInt(o.value))}),e.btnPrintCancel.addEventListener("click",()=>e.printModal.classList.add("hidden")),e.btnClosePrintModal.addEventListener("click",()=>e.printModal.classList.add("hidden")),window.addEventListener("keydown",o=>{o.target.isContentEditable||o.composedPath().some(a=>a.isContentEditable)||["INPUT","TEXTAREA","SELECT"].includes(o.target.tagName)||((o.key==="ArrowDown"||o.key==="ArrowRight")&&c.currentIndex<c.slides.length-1&&L(c.currentIndex+1),(o.key==="ArrowUp"||o.key==="ArrowLeft")&&c.currentIndex>0&&L(c.currentIndex-1))})}function Y(n){const i=new DOMParser().parseFromString(n,"text/html");c.globalStyles=Array.from(i.querySelectorAll("style")).map(s=>s.textContent).join(`
`);const o=i.querySelectorAll("section").length?Array.from(i.querySelectorAll("section")):i.querySelectorAll(".slide").length?Array.from(i.querySelectorAll(".slide")):[i.body];c.slides=o.map((s,a)=>({id:`imported-${a}`,content:s===i.body?s.innerHTML:s.outerHTML,css:""})),F(),L(0)}function R(){const n=document.querySelector(".editor-viewport"),t=e.editorContainer;if(!n||!t)return;const i=80,o=Math.min((n.clientWidth-i)/1122.52,(n.clientHeight-i)/793.7);t.style.transform=`scale(${Math.max(o,.1)}) translate(-50%, -50%)`,t.style.left="50%",t.style.top="50%",t.style.position="absolute"}function te(n=1){const t=e.printFrame,i=t.contentWindow.document,o={1:{orientation:"landscape",cols:1,rows:1},4:{orientation:"portrait",cols:2,rows:2},6:{orientation:"portrait",cols:2,rows:3},8:{orientation:"portrait",cols:2,rows:4}},s=o[n]||o[1],a=c.globalStyles.replace(/@page\s*\{[^}]*\}/gi,"").replace(/(?:^|\})\s*(?:html|body)\s*\{[^}]*\}/gi,"}"),l=97,r=68.6,m=3,p=((210-(l*2+m))/2).toFixed(1),v=(l/297).toFixed(6);let b="";if(n===1)b=c.slides.map(f=>`<div class="print-page">${f.content}</div>`).join("");else{const f=[];for(let y=0;y<c.slides.length;y+=n)f.push(c.slides.slice(y,y+n));b=f.map(y=>`<div class="handout-page">${y.map(x=>`<div class="grid-cell"><div class="cell-slide" style="zoom:${v}">${x.content}</div></div>`).join("")}</div>`).join("")}const I=`
    ...
    * { box-sizing: border-box; }
    ...
    ${a}
  `;i.open(),i.write(`<html><head><style>${I}</style></head><body>${b}</body></html>`),i.close(),setTimeout(()=>{t.contentWindow.focus(),t.contentWindow.print()},500)}function ne(n){let t=c.globalStyles.replace(/100vw/g,"100%").replace(/100vh/g,"100%").replace(/(^|,)\s*body(?=\s|\{|,)/gi,"$1 .slide-frame").replace(/html(?=\s|\{|,)/gi,".slide-frame");const i=c.slides.map((r,m)=>`<div class="slide-a4-container" id="slide-${m}"><div class="slide-frame">${r.content}</div></div>`).join(`
`);let o="";n&&(o=`
    <div id="ui-layer">
